...
export default function blogPost({post}) {
    ...
    <div className={styles.wrapper}>
        ...
        {/* <ReactMarkdown className={styles.myPostDesc}>{post.data[0].attributes.Content}</ReactMarkdown> */}
        <ReactMarkdown source={post.data[0].attributes.Content} className={styles.myPostDesc}>{post.data[0].attributes.Content}</ReactMarkdown>
